...
* **Réponse :** Faux. S’il y a un directeur de plongée (cas général), tous les plongeurs doivent suivre ses directives.
...
* **Réponse :** Organiser l’activité, veiller au respect des règles techniques et de sécurité. En milieu naturel, le DP est habituellement E3 (MF1, BEES1, DEJEPS). Sous conditions, il peut être P5.

**14. Dans quels cas des plongeurs P3 (PA60) peuvent-ils organiser leur plongée entre eux ?**

* **Réponse :** En l’absence de DP, ils sont alors limités à 40 m (voir réponse à la question 1).

**15. Quels sont les principaux points de repères permettant de s’orienter en plongée ?**

* **Réponse :** Soleil, profondeur, conformation des fonds (sable, forme des roches...), etc.

**16. Indiquez où se situent le Nord, le Sud, l’Est et l’Ouest sur une boussole. Donnez la réponse en degrés.**

* **Réponse :** Nord (0° ou 360°) ; Sud (180°) ; Est (90°) ; Ouest (270°).

**17. Vous faites cap au 120. Vous devez changer de direction pour aller au 180. Vous tournez à droite ou à gauche ?**

* **Réponse :** À droite (« les degrés augmentent »).
...
* **Réponse :** Parcours « en carré » ou « en branche d’étoile » ; boussole ; etc.
...
* **Réponse :** Noyade ; essoufflement ; mal de dos ; atteinte à la faune et à la flore (palmage debout) ; etc.
...
* **Réponse :** Début de plongée : gilet vide en surface, sur une légère expiration, le plongeur s'enfonce jusqu’aux yeux. Fin de plongée : avec 50 bars dans le bloc, gilet vide, le plongeur se maintient sans effort à 3 m.
...
* **Réponse :** Cela peut provenir de la technique d’immersion, imparfaitement exécutée. Canard : jambes qui ne sortent pas suffisamment de l'eau. Phoque : expiration insuffisante ou trop lente.

**25. Quels sont les risques liés à une mauvaise gestion de la consommation d’air et donc à une panne d’air ?**

* **Réponse :** Noyade ; surpression pulmonaire (remontée en panique) ; accident de désaturation (remontée rapide, impossibilité d'effectuer les paliers).
...
* **Réponse :** Limitation des efforts sous l’eau ; insister sur l’expiration ; maintenir une bonne forme physique ; pratiquer des apnées de contrôle ; etc.

**28. Si vous disposez d’une autonomie de 50 min à 20 m, quelle est-elle à 50 m (en conservant le même équipement) ?**

* **Réponse :** 20 m (3 bars) contre 50 m (6 bars). La pression est multipliée par 2, l'autonomie est donc divisée par 2, soit 25 min. Ces 25 min doivent intégrer le temps de remontée et les paliers, plus longs qu’à 20 m.

**29. Quelle est l’utilité d’un parachute de palier ?**

* **Réponse :** Se signaler aux embarcations en surface et à la personne assurant la sécurité de surface.

**30. Quels sont les risques si l’on effectue un palier en pleine eau, sans se signaler ?**

* **Réponse :** Risque de dérive importante pouvant être fatale selon le sens de cette dérive (ex. vers le large). Le risque est accru en fin de journée (tombée de la nuit rendant les recherches difficiles).
...
* **Réponse :** Absence de contre-indication datant de moins d’un an.

**33. Pour plonger en exploration, quel médecin peut délivrer le certificat médical ?**

* **Réponse :** Tout médecin.
...
* **Réponse :** Noyade, accident de désaturation (comportement inadapté), etc.

**38. Comment prévenir les risques de narcose ?**

* **Réponse :** Entraînement progressif avec des encadrants expérimentés ; descente ralentie après 30 m ; etc.

**39. Qu’est-ce qu’un essoufflement ?**

* **Réponse :** Manifestation ventilatoire d’une intoxication au gaz carbonique.

**40. Quels sont les risques liés à un essoufflement ?**

* **Réponse :** Panne d’air ; noyade ; surpression pulmonaire ; accident de désaturation ; etc.
...
* **Réponse :** Oreilles ; sinus ; placage de masque ; dents ; surpression stomacale ou intestinale.

**51. En plongée, quelles peuvent être les atteintes causées aux oreilles ?**

* **Réponse :** Barotraumatisme de l’oreille moyenne ; atteinte du tympan ; barotraumatisme de l’oreille interne (« coup de piston ») ; accident de désaturation de l’oreille interne ; vertige alterno-barique ; otite infectieuse.

**52. Quelles méthodes d’équilibrage connaissez-vous ?**

* **Réponse :** Descente : souffler par le nez dans le masque ; Valsalva ; Lowry ; Edmonds ; Frenzel ; BTV ; simple déglutition. Remontée : Toynbee.
...
* **Réponse :** Risque accru d'œdème pulmonaire d'immersion (OPI) et d'accident de désaturation (ADD).

**57. Quelles sont les principales causes du refroidissement en plongée ? Comment éviter d’avoir froid en plongée ?**

* **Réponse :** Contact avec l'eau (le corps plus chaud que l'eau se refroidit) ; circulation de l'eau (l'eau emporte de la chaleur avec elle) ; ventilation (réchauffe l'air du bloc). Bien se couvrir avant la plongée ; nourriture ; combinaison adaptée ; limitation du temps de plongée.

**58. Quelle est la conduite à tenir en cas de froid sous l’eau puis de retour en surface ?**

* **Réponse :** Fin de plongée ; accroître les paliers. Déséquiper ; sécher (sans frotter ni frictionner) ; vêtements chauds ; allonger ; réchauffement progressif du corps ; boisson chaude et sucrée ; etc.

**59. Quels problèmes de détendeur peut poser la plongée en eaux très froides ?**

* **Réponse :** Givrage du détendeur ; panne d'air ; noyade.

**60. Quels peuvent être les risques liés aux animaux marins ?**

* **Réponse :** Piqûres (venin) ; morsures ; brûlures (venin).

**61. Quels risques peuvent être dus au courant ?**

* **Réponse :** Essoufflement ; perte du bateau ; etc.

**62. Quels sont les risques lors de plongées en eau trouble ?**

* **Réponse :** Perte de sa palanquée ; erreur d'orientation ; etc.

**63. Quels sont les risques liés aux grottes et tunnels ?**

* **Réponse :** Rester bloqué et se noyer.

**64. Quels sont les risques liés aux plongées sur épaves ?**

* **Réponse :** Se perdre dans l'épave et se noyer (ne pas pénétrer) ; rester accroché à un filet ; etc.

**65. Quels sont les risques en plongée de nuit ? Quelles sont les précautions à prendre ?**

* **Réponse :** Perte du bateau. Plonger peu profond, à proximité du bateau.

**66. Quelles sont les précautions à prendre lorsqu’on pratique de l’apnée ?**

* **Réponse :** Jamais d'hyperventilation ; toujours 2 par 2 (surveillance et assistance) ; périodes de récupération ; lestage correct ; etc.
...
* **Réponse :** Danger : yo-yo. À éviter : intervalle court en surface ; profils inversés.

**74. Quels sont les comportements à éviter pour prévenir les risques d’accident de désaturation ?**

* **Réponse :** Éviter mise en hyperpression du thorax ; éviter effort violent (2 h) ; éviter apnée (6 h) ; éviter montée en altitude ou en avion (12 à 24 h) ; pas plus de 2 plongées par 24 h ; etc.
...
* **Réponse :** Représentation simplifiée des réactions du corps humain face au phénomène de charge et décharge d'azote.

**95. Indiquez les différences entre une table de plongée et un ordinateur de plongée.**

* **Réponse :** Table : profil carré. Ordinateur : suit le profil du plongeur.

**96. Qu’est-il conseillé de vérifier sur son ordinateur avant de plonger ?**

* **Réponse :** Piles, mode de plongée (air, nitrox, profondimètre, apnée)...

**97. À quoi correspond la fonction « facteurs de prudence » ou « personnalisation » sur un ordinateur de plongée ?**

* **Réponse :** Tentative de prise en compte des facteurs individuels de risque.

**98. À quoi sert la fonction « planification » d’un ordinateur de plongée ?**

* **Réponse :** Permet de préparer ses plongées (temps sans palier, paliers).
...
* **Réponse :** Voir page 245.

**129. Citez 2 nœuds d’usage courant en plongée.**

* **Réponse :** Voir pages 246-250.
